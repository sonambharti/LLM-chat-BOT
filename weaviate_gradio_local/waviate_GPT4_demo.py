...
def ques_responses(question_template, history, system_prompt, token):
    ...
    # system = "You are Meera, an Virtual Parliamentary Assistant that follows instruction and behaves with extremely positive sentiments and answers directly."

    # template = """
    #     instruction: '''Always greet with Hello, I am your virtual assistant Meera and end the reponse with "thanks for asking"'''
    ...
    system = 'You are an AI assistant named "meera" that follows instruction extremely well stepwise. Help as much as you can.'
    ...
    prompt = PromptTemplate(template=template, input_variables=["system","instruction","question"])
